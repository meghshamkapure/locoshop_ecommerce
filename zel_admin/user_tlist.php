...
<div class="container-fluid" style="margin-top:20px">
	...
	<div class="panel panel-info" style="border-color: #004c91;">
		  <div class="panel-heading" style="color: #ffffff;background-color: #004c91;border-color: #004c91;" align="center">Search User</div>
		  <div class="panel-body">
			<form class="form-inline" data-toggle="validator" name="sub" id="sub" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<div class="col-md-6" >
					...
					<button type="submit" class="btn btn-info" style="background-color: #004c91;" id ="submitbymob" name="submitbymob">Search By Mobile</button>
					</div>
				</div>
				<div class="col-md-6" >
					<div class="form-group">
					...
					<div class="form-group" align="center">
					<button type="submit" class="btn btn-info auto" style="background-color: #004c91;" id ="submitbyname" name="submitbyname">Search By Name</button>
					</div>
				</div>
			</form>
...
<div class="panel panel-info" style="border-color: #004c91;" >
      <div class="panel-heading" style="color: #ffffff;background-color: #004c91;border-color: #004c91;" align="center">User Details</div>
      <div class="panel-body">
		   ...
		   echo "<td>".$row['euname']."</td>";
              ...
              echo "<td>".date( 'd/m/Y', strtotime($row['bdate']))."</td>";
			   ...
			   echo "<td>".date( 'd/m/Y', strtotime($row['euregdate']))."</td>";
			    echo  "<td> <button type='submit' class='btn btn-default btn-sm' onclick='delete_enduser(".$row['euid'].")' name ='btndel' id='btndel'> <span class='glyphicon glyphicon-trash'></span> Delete</button></td>";
				echo "</tr>";
         }
