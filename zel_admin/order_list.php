...
if (isset($_POST['submitstatus'])){
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "SELECT * FROM orders o, franchise f WHERE f.fr_id=o.fr_id AND o.order_status=$order_status ORDER BY o.order_id DESC";
	}
}
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "SELECT * FROM orders o, franchise f WHERE f.fr_id=o.fr_id AND o.order_status= 1 AND order_date BETWEEN '$datefrom' AND '$dateto' ORDER BY o.order_id DESC";
	}
}
else{
	$sql = "SELECT * FROM orders o, franchise f WHERE f.fr_id=o.fr_id AND o.order_status= 1 ORDER BY o.order_id DESC";
}
...
<div class="row">
	...
	<div class="panel panel-info">
		  <div class="panel-heading" align="center">Search Orders  </div>
...
<div class="col-md-12">
<div class="panel panel-info">
      <div class="panel-heading" align="center">Orders List <a class="pull-right" align="right" href="#" onclick=printbill(); >Print List</a></div>
      <div class="panel-body">
      ...
      if ($result->num_rows > 0) {
          ...
          <thead>
            <tr>
              ...
              <th style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>Franchise Name </th>
              <th style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>Mobile No. </th>
              <th style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>City </th>
          ...
          while($row = $result->fetch_assoc()) {
           ...
           echo"<tr>";
              ...
              echo "<td style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>".$row['name']."</td>"; 
              echo "<td style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>".$row['mob']."</td>"; 
              echo "<td style='text-align:left; border-bottom: 1px solid #ddd; padding: 3px;'>".$row['shop_location']."</td>";
