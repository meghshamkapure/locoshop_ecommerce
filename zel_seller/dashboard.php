...
//Colunt end user
$sql = "SELECT * FROM products WHERE status=1 AND sid=$user_id";
$query = $conn->query($sql);
$countproduct = $query->num_rows;
$sql = "SELECT * FROM products WHERE status=1 AND regdate='$today' AND sid=$user_id";
$query = $conn->query($sql);
$counttodaysproduct = $query->num_rows;
//Colunt total photos
$sql = "SELECT * FROM end_user WHERE status=1";
$query = $conn->query($sql);
$counteuser = $query->num_rows;
//Colunt today photos
$sql = "SELECT * FROM orders o, products p, seller s WHERE s.sid=p.sid AND o.order_status=1 AND p.sid=$user_id";
$query = $conn->query($sql);
$countorders = $query->num_rows;
$sql = "SELECT * FROM orders o, products p, seller s WHERE s.sid=p.sid AND o.order_status=1 AND order_date='$today' AND s.sid=$user_id";
$query = $conn->query($sql);
	...
	<div class="col-md-8">
		...
		<div class="card">
		  <div class="cardHeader" style="background-color:#245580;">
		    <h1><?php if($counttodaysproduct) {
		    	echo $counttodaysproduct;
