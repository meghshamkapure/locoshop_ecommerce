...
if (isset($_GET['order_id'])) {	
    ...
    $sql = "SELECT * FROM orders o, end_user e WHERE e.euid=o.euid AND o.order_id=$order_id";
		...
		<div style="text-align:center; border:0px solid #ccc; float:left; width:690px;">
          ...
          <tbody>
			<tr>
			  ...
			  <td width="100" style='text-align:left; font-size:15px; font-style:bold; padding: 0px;'><b>Customer Id</b></td>
				...
				<table border="1" style= "width:100%; font-size:12px;  border-collapse:collapse;">
					<thead>
						<tr>			  			
					        ...
					        <th style="width:35%; text-align:left;">Id </th>
					...
					<tbody>
						<?php 
							...
							echo"<tr>								  			
								...
								<td style='text-align:left;  padding: 3px;'>".$row['pid']."</td>							
							...
							echo"<tr>
								<td colspan='9' style='text-align:right;  padding: 3px;'> <b>Total Amount:</b></td>
