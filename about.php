...
<!-- Mirrored from designing-world.com/suha-v2.1.0/notification-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Sep 2020 08:34:46 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="header-area" id="headerArea">
      <div class="container-fluid h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">About Amplewish</h6>
        </div>
        <!-- Navbar Toggler-->
